...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "@workspaces/dashboard-client",
        "reference": "workspace:dashboard/client"
      },
      {
        "name": "@workspaces/dashboard-server",
        "reference": "workspace:dashboard/server"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.vscode\\/pnpify(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["@workspaces/common", ["workspace:common"]],
      ["@workspaces/dashboard", ["workspace:dashboard"]],
      ["@workspaces/dashboard-client", ["workspace:dashboard/client"]],
      ["@workspaces/dashboard-server", ["workspace:dashboard/server"]],
    ...
    "packageRegistryData": [
      ...
      ["@workspaces/dashboard-client", [
        ["workspace:dashboard/client", {
          "packageLocation": "./dashboard/client/",
          "packageDependencies": [
            ["@workspaces/dashboard-client", "workspace:dashboard/client"],
            ["@workspaces/common", "workspace:common"],
            ["@workspaces/dashboard-server", "workspace:dashboard/server"]
      ...
      ["@workspaces/dashboard-server", [
        ["workspace:dashboard/server", {
          "packageLocation": "./dashboard/server/",
          "packageDependencies": [
            ["@workspaces/dashboard-server", "workspace:dashboard/server"]
          ],
          "linkType": "SOFT",
